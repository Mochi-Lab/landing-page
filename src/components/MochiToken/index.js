            ...
            <div className='col-12 col-md-6'>
              <div className='description-mochi-team'>
                ...
                <div className='text-mochi-team'>
                  The MOCHI governance token was designed to incentivize ecosystem participants to
                  contribute to developing the Mochi Ecosystem. MOCHI token holders will be able to
